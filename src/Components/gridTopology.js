		...
		return (
			<div>
				<DataTable
					...
					rowKeyColumn='id'
					rows={[
						{ id: 1001, material: 'Acrylic (Transparent)', value: 25, price: 2.9 },
					...
					<TableHeader numeric name='value' tooltip='Number of materials'>
						Quantity
					</TableHeader>
					<TableHeader numeric name='price' tooltip='Price pet unit'>
						Price
					</TableHeader>
				</DataTable>
			</div>
